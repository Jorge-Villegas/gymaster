...
class EjercicioDataSeed {
  ...
  Future<void> seedGenerateEjercicios() async {
    try {
      List<ExerciseDbModel> trapecio = List.from([
        ExerciseDbModel(
          ...
          imagePath: Assets.imagenes.musculos.trapecio
        ...
        ExerciseDbModel(
          ...
          imagePath: Assets
              .imagenes.musculos.trapecio.remoVerticalConCablePoleaDePie.path,
          description:
        ...
        ExerciseDbModel(
          ...
          imagePath: Assets
              .imagenes.musculos.trapecio.remoVerticalConMancuernaDePie.path,
          description:
      ...
      List<ExerciseDbModel> ejerciciosHombro = List.from([
        ExerciseDbModel(
          createdAt: DateTime.now().toIso8601String(),
          id: idGenerator.generateId(),
          name: 'Apertura con maquina invertida (acostado)',
          imagePath: Assets.imagenes.musculos.hombro
              .aperturaConMaquinaInvertidaAcostado.path,
          description:
      ...
      List<ExerciseDbModel> ejerciciosPecho = List.from([
        ExerciseDbModel(
          createdAt: DateTime.now().toIso8601String(),
          id: idGenerator.generateId(),
        ...
        ExerciseDbModel(
          ...
          imagePath: Assets.imagenes.musculos.pecho
      ...
      List<ExerciseDbModel> ejerciciosTriceps = List.from([
        ExerciseDbModel(
          createdAt: DateTime.now().toIso8601String(),
          id: idGenerator.generateId(),
          name:
          ...
          imagePath: Assets.imagenes.musculos.triceps
      ...
      List<ExerciseDbModel> antebrazo = List.from([
        ExerciseDbModel(
          createdAt: DateTime.now().toIso8601String(),
          id: idGenerator.generateId(),
          ...
          imagePath: Assets.imagenes.musculos.antebrazo
      ...
      List<ExerciseDbModel> abdominales = List.from([
        ExerciseDbModel(
          createdAt: DateTime.now().toIso8601String(),
          id: idGenerator.generateId(),
        ...
        ExerciseDbModel(
          ...
          imagePath: Assets.imagenes.musculos.abdomen
        ...
        ExerciseDbModel(
          ...
          imagePath: Assets
              .imagenes.musculos.abdomen.tocarLosDedosDeLosPiesAcostado.path,
        ),
      ]);

      List<ExerciseDbModel> espalda = List.from([
        ExerciseDbModel(
          createdAt: DateTime.now().toIso8601String(),
          id: idGenerator.generateId(),
          ...
          imagePath: Assets.imagenes.musculos.espalda
        ...
        ExerciseDbModel(
          ...
          imagePath: Assets.imagenes.musculos.espalda
              .stepUpConBarraDePesasInclinadoDePie.path,
        ),
      ]);

      List<ExerciseDbModel> espaldaBaja = List.from([
        ExerciseDbModel(
          createdAt: DateTime.now().toIso8601String(),
          id: idGenerator.generateId(),
          ...
          imagePath: Assets.imagenes.musculos.espaldaBaja
      ...
      List<ExerciseDbModel> gluteos = List.from([
        ExerciseDbModel(
          createdAt: DateTime.now().toIso8601String(),
          id: idGenerator.generateId(),
          name: 'Arrastre Mediante con Cuerda y Polea (de pie)',
          description:
              'De pie frente a una máquina de polea con cuerda, agarra las asas con ambas manos. Mantén la espalda recta y los brazos extendidos. Tira de la cuerda hacia abajo y hacia atrás, llevando los omóplatos juntos. Controla el movimiento al regresar la cuerda a la posición inicial.',
          imagePath: Assets.imagenes.musculos.gluteo
              .arrastreMedianteConCuerdaYPoleaDePie.path,
        ),
        ExerciseDbModel(
          createdAt: DateTime.now().toIso8601String(),
      ...
      List<ExerciseDbModel> cuadriceps = List.from([
        ExerciseDbModel(
          createdAt: DateTime.now().toIso8601String(),
          id: idGenerator.generateId(),
        ...
        ExerciseDbModel(
          ...
          imagePath: Assets.imagenes.musculos.cuadriceps
      ...
      List<ExerciseDbModel> femorales = List.from([
        ExerciseDbModel(
          createdAt: DateTime.now().toIso8601String(),
          id: idGenerator.generateId(),
          ...
          imagePath: Assets.imagenes.musculos.femorales
        ...
        ExerciseDbModel(
          ...
          imagePath: Assets.imagenes.musculos.femorales
              .flexionesDePiernaConCablePoleaDePie.path,
        ),
      ]);

      List<ExerciseDbModel> pantorrilla = List.from([
        ExerciseDbModel(
          createdAt: DateTime.now().toIso8601String(),
          id: idGenerator.generateId(),
          ...
          imagePath: Assets.imagenes.musculos.pantorrilla
      ...
      List<ExerciseDbModel> biceps = List.from([
        ExerciseDbModel(
          createdAt: DateTime.now().toIso8601String(),
          id: idGenerator.generateId(),
          name: 'Dominadas en Maquina Sostenida, Agarre Medio por Debajo',
          ...
          imagePath: Assets.imagenes.musculos.biceps
              .dominadasEnMaquinaSostenidaAgarreMedioPorDebajo.path,
        ),
        ExerciseDbModel(
          createdAt: DateTime.now().toIso8601String(),
  ...
  Future<int> _insertarEjercicio(
    List<ExerciseDbModel> ejercicios,
    ...
    for (var ejercicio in ejercicios) {
      ...
      if (existingEjercicio.isEmpty) {
        ...
        res += await db.insert(ExerciseDbModel.table, ejercicio.toJson());
      } else {
